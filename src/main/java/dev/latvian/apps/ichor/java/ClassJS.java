...
public class ClassJS {
	public static final Prototype PROTOTYPE = new PrototypeBuilder("JavaClass")
			...
			.property("name", ClassJS::name)
			.constant("class", Class.class)
			.property("superclass", ClassJS::superclass)
			.property("interface", ClassJS::isInterface)
			.property("array", ClassJS::isArray)
			.property("enum", ClassJS::isEnum)
			.property("primitive", ClassJS::isPrimitive)
			.property("annotation", ClassJS::isAnnotation)
			.property("synthetic", ClassJS::isSynthetic)
			.property("package", ClassJS::getPackage)
			.property("descriptor", ClassJS::descriptor)
			.property("simpleName", ClassJS::simpleName)
			.property("componentType", ClassJS::componentType)
